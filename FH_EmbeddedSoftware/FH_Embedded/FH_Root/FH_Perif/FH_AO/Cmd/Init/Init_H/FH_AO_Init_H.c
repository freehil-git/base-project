/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Root</b>, Section <b>FH_Perif</b>, <b>FH_AO</b> (Analog Output), <b>Cmd</b> (Command), <b>Init</b>, <b>Init_H</b> (Init Health)\n
  *       Functions in this file, verify the health of the different message frames related to <b>AO</b> (Analog Output)
  *
...
/**
 * @brief This function verifies the health of <b>FH_AO_Commands_Init</b> command
 *
...
*/
FH_ErrorInfo FH_AO_Init_H(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	if (FH_MessageDataLength < FH_AO_MinCommandSize_Init)    // If the length is less than expected value
	{
