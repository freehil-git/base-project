/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Root</b>, Section <b>FH_Perif</b>, <b>FH_AO</b> (Digital Output), <b>Cmd</b> (Command), <b>SetStatus</b>, <b>SetStatus_H</b> (SetStatus Health)\n
  *       Functions in this file, verify the health of the different message frames related to <b>AO</b> (Digital Output)
  *
...
/**
 * @brief This function verifies the health of <b>FH_AO_Commands_SetStatus</b> command
 *
...
*/
FH_ErrorInfo FH_AO_SetStatus_H(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	if (FH_MessageDataLength < FH_AO_MinCommandSize_SetStatus)    // If the length is less than expected value
	{
	...
	if (FH_PeripheralNumber == 0 || FH_PeripheralNumber > FH_AO_MaxPeripheralNumber)    // If the PeripheralNumber is not within the expected value
	{
		fh_ErrorInfo.error_code = FH_ERROR_MessageFrame;    // There is message frame error
		return fh_ErrorInfo;
	}
