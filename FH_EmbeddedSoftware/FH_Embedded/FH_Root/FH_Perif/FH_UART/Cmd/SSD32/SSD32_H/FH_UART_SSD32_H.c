/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Root</b>, Section <b>FH_Perif</b>, <b>FH_UART</b>, <b>Cmd</b> (Command), <b>SSD32</b>, <b>SSD32_H</b> (Set Shared Data 32 Health)\n
...
/**
 * @brief This function verifies the health of <b>FH_UART_Commands_SSD32</b> command
 *
...
*/
FH_ErrorInfo FH_UART_SSD32_H(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	if (FH_MessageDataLength < FH_UART_MinCommandSize_SSD32)    // If the length is less than expected value
	{
	...
	FH_PeripheralNumber = fh_RFCommunication_Message -> Data[UART_SSD32_PeripheralNumber];
	...
	FH_SharedDataLength  = fh_RFCommunication_Message -> Data[UART_SSD32_SharedDataLength];
