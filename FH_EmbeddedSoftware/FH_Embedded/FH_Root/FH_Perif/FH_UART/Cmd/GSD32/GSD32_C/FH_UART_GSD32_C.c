/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Root</b>, Section <b>FH_Perif</b>, <b>FH_UART</b>, <b>Cmd</b> (Command), <b>GSD32</b>, <b>GSD32_C</b> (Get Shared Data 32 Call)\n
...
*/
FH_ErrorInfo FH_UART_GSD32_C (FH_RFCommunication_Message* fh_RFCommunication_Message, uint8_t* SharedDataLength, uint8_t* SharedData, FH_UART_GSD32_FuncPtrModel *fH_UART_GSD32_FuncPtr)
{
	...
	{
		if (i == fh_RFCommunication_Message -> Data[UART_GSD32_PeripheralNumber])    // If the PeripheralNumber in the message frame is met
		{
			if (fH_UART_GSD32_FuncPtr[i-1] != NULL_PTR)    // If the address of the function is truly assigned
			{
				fh_ErrorInfo = fH_UART_GSD32_FuncPtr[i-1](fh_RFCommunication_Message, SharedDataLength, SharedData);    // Call the related function
			}
			else
			{
