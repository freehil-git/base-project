...
/**
 * @brief This function verifies the health of <b>FH_UART_Commands_GSD32</b> command
 *
...
FH_ErrorInfo FH_UART_GSD32_H(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	if (FH_MessageDataLength < FH_UART_MinCommandSize_GSD32)    // If the length is less than expected value
	{
	...
	FH_PeripheralNumber = fh_RFCommunication_Message -> Data[UART_GSD32_PeripheralNumber];
