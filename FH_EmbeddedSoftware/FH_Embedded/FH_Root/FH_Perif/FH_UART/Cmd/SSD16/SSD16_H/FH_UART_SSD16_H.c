/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Root</b>, Section <b>FH_Perif</b>, <b>FH_UART</b>, <b>Cmd</b> (Command), <b>SSD16</b>, <b>SSD16_H</b> (Set Shared Data 16 Health)\n
...
/**
 * @brief This function verifies the health of <b>FH_UART_Commands_SSD16</b> command
 *
...
*/
FH_ErrorInfo FH_UART_SSD16_H(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	if (FH_MessageDataLength < FH_UART_MinCommandSize_SSD16)    // If the length is less than expected value
	{
	...
	FH_PeripheralNumber = fh_RFCommunication_Message -> Data[UART_SSD16_PeripheralNumber] ;
	...
	FH_SharedDataLength  = fh_RFCommunication_Message -> Data[UART_SSD16_SharedDataLength];
