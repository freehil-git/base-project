/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Root</b>, Section <b>FH_Perif</b>, <b>FH_UART</b>, <b>Cmd</b> (Command), <b>Receive</b>, <b>Receive_H</b> (Receive Health)\n
...
/**
 * @brief This function verifies the health of <b>FH_UART_Commands_Receive</b> command
 *
...
*/
FH_ErrorInfo FH_UART_Receive_H(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	if (FH_MessageDataLength < FH_UART_MinCommandSize_Receive)    // If the length is less than expected value
	{
	...
	FH_PeripheralNumber = fh_RFCommunication_Message -> Data[UART_Receive_PeripheralNumber] ;
