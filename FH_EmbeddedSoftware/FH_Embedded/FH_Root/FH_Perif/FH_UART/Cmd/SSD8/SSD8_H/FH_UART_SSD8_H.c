/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Root</b>, Section <b>FH_Perif</b>, <b>FH_UART</b>, <b>Cmd</b> (Command), <b>SSD8</b>, <b>SSD8_H</b> (Set Shared Data 8 Health)\n
...
/**
 * @brief This function verifies the health of <b>FH_UART_Commands_SSD8</b> command
 *
...
*/
FH_ErrorInfo FH_UART_SSD8_H(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	if (FH_MessageDataLength < FH_UART_MinCommandSize_SSD8)    // If the length is less than expected value
	{
	...
	FH_PeripheralNumber = fh_RFCommunication_Message -> Data[UART_SSD8_PeripheralNumber];
	...
	FH_SharedDataLength  = fh_RFCommunication_Message -> Data[UART_SSD8_SharedDataLength];
