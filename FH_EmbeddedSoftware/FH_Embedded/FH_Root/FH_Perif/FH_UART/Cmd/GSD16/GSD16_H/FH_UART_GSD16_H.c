/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Root</b>, Section <b>FH_Perif</b>, <b>FH_UART</b>, <b>Cmd</b> (Command), <b>GSD16</b>, <b>GSD16_H</b> (Get Shared Data 16 Health)\n
...
/**
 * @brief This function verifies the health of <b>FH_UART_Commands_GSD16</b> command
 *
...
*/
FH_ErrorInfo FH_UART_GSD16_H(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	if (FH_MessageDataLength < FH_UART_MinCommandSize_GSD16)    // If the length is less than expected value
	{
	...
	FH_PeripheralNumber = fh_RFCommunication_Message -> Data[UART_GSD16_PeripheralNumber];
