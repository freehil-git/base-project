/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Root</b>, Section <b>FH_Perif</b>, <b>FH_UART</b>, <b>Cmd</b> (Command), <b>GSD8</b>, <b>GSD8_C</b> (Get Shared Data 8 Call)\n
...
*/
FH_ErrorInfo FH_UART_GSD8_C (FH_RFCommunication_Message* fh_RFCommunication_Message, uint8_t* SharedDataLength, uint8_t* SharedData, FH_UART_GSD8_FuncPtrModel *FH_UART_GSD8_FuncPtr)
{
	...
	{
		if (i == fh_RFCommunication_Message -> Data[UART_GSD8_PeripheralNumber])    // If the PeripheralNumber in the message frame is met
		{
			if (FH_UART_GSD8_FuncPtr[i-1] != NULL_PTR)    // If the address of the function is truly assigned
			{
				fh_ErrorInfo = FH_UART_GSD8_FuncPtr[i-1](fh_RFCommunication_Message, SharedDataLength, SharedData);    // Call the related function
			}
			else
			{
