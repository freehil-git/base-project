/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Root</b>, Section <b>FH_Perif</b>, <b>FH_UART</b>, <b>Cmd</b> (Command), <b>GSD8</b>, <b>GSD8_H</b> (Get Shared Data 8 Health)\n
...
/**
 * @brief This function verifies the health of <b>FH_UART_Commands_GSD8</b> command
 *
...
*/
FH_ErrorInfo FH_UART_GSD8_H(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	if (FH_MessageDataLength < FH_UART_MinCommandSize_GSD8)    // If the length is less than expected value
	{
	...
	FH_PeripheralNumber = fh_RFCommunication_Message -> Data[UART_GSD8_PeripheralNumber];
	if (FH_PeripheralNumber == 0 || FH_PeripheralNumber > FH_UART_MaxPeripheralNumber)
	{
		fh_ErrorInfo.error_code = FH_ERROR_MessageFrame;    // There is message frame error
		return fh_ErrorInfo;
	}
