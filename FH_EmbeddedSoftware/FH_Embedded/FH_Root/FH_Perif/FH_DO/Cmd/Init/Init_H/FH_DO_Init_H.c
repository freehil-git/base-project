/**
  ...
  * @brief
  *       <b>File Map:</b>\n
*       <b>FH_Root</b>, Section <b>FH_Perif</b>, <b>FH_DO</b> (Digital Output), <b>Cmd</b> (Command), <b>Init</b>, <b>Init_H</b> (Init Health)\n
...
/**
 * @brief This function verifies the health of <b>FH_DO_Commands_Init</b> command
 *
...
FH_ErrorInfo FH_DO_Init_H(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	if (FH_MessageDataLength < FH_DO_MinCommandSize_Init)    // If the length is less than expected value
	{
...
/**
 * @brief This function verifies the health of <b>FH_DO_Commands_InitMULTI</b> command
 *
 * @param  fh_RFCommunication_Message
 *         The message frame set by <b>RobotFramework</b>
 *
...
FH_ErrorInfo FH_DO_InitMULTI_H(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	uint8_t FH_MessageDataLength;    // It temporarily stores the DataLength of the message frame

	// Verifying the minimum possible length in the message frame
	FH_MessageDataLength =	fh_RFCommunication_Message -> DataLength;
	if (FH_MessageDataLength < FH_DO_MinCommandSize_InitMULTI)    // If the length is less than expected value
	{
		fh_ErrorInfo.error_code = FH_ERROR_MessageFrame;    // There is message frame error
		return fh_ErrorInfo;
	}
