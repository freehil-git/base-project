/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Root</b>, Section <b>FH_Perif</b>, <b>FH_CAN</b>, <b>Cmd</b> (Command), <b>ReceiveW</b>, <b>ReceiveW_H</b> (ReceiveW Health)\n
...
/**
 * @brief This function verifies the health of <b>FH_CAN_Commands_ReceiveW</b> command
 *
...
*/
FH_ErrorInfo FH_CAN_ReceiveW_H(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	if (FH_MessageDataLength < FH_CAN_MinCommandSize_ReceiveW)    // If the length is less than expected value
	{
	...
	FH_PeripheralNumber = fh_RFCommunication_Message -> Data[CAN_ReceiveW_PeripheralNumber] ;
	...
	FH_MaxTimerCount = FH_ConvertUint8ToUint32(&fh_RFCommunication_Message -> Data[CAN_ReceiveW_MaxTimerCount]);
