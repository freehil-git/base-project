/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Root</b>, Section <b>FH_Perif</b>, <b>FH_CAN</b>, <b>Cmd</b> (Command), <b>SSD8</b>, <b>SSD8_H</b> (Set Shared Data 8 Health)\n
...
/**
 * @brief This function verifies the health of <b>FH_CAN_Commands_SSD8</b> command
 *
...
*/
FH_ErrorInfo FH_CAN_SSD8_H(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	if (FH_MessageDataLength < FH_CAN_MinCommandSize_SSD8)    // If the length is less than expected value
	{
	...
	FH_PeripheralNumber = fh_RFCommunication_Message -> Data[CAN_SSD8_PeripheralNumber];
	...
	FH_SharedDataLength  = fh_RFCommunication_Message -> Data[CAN_SSD8_SharedDataLength];
	...
	if (FH_SharedDataLength != (FH_MessageDataLength - 2))    // If SharedDataLength is not matched with the length of the message frame
	{
		fh_ErrorInfo.error_code = FH_ERROR_MessageFrame;    // There is message frame error
		return fh_ErrorInfo;
	}
