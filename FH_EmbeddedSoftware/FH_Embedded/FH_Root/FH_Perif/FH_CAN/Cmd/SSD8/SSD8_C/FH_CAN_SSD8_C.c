/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Root</b>, Section <b>FH_Perif</b>, <b>FH_CAN</b>, <b>Cmd</b> (Command), <b>SSD8</b>, <b>SSD8_C</b> (Set Shared Data 8 Call)\n
 ...
 * @verbatim
    ...
    02 => Example interested length of the 8 bit data to be set
    AA    BB    CC    DD => Example data (0xAABB and 0xCCDD) to be set in <b>FH_CAN01_SharedDataBuf_8Bits</b>
...
*/
FH_ErrorInfo FH_CAN_SSD8_C (FH_RFCommunication_Message* fh_RFCommunication_Message, FH_CAN_SSD8_FuncPtrModel *FH_CAN_SSD8_FuncPtr)
{
	...
	{
		if (i == fh_RFCommunication_Message -> Data[CAN_SSD8_PeripheralNumber])    // If the PeripheralNumber in the message frame is met
		{
			if (FH_CAN_SSD8_FuncPtr[i-1] != NULL_PTR)    // If the address of the function is truly assigned
			{
				fh_ErrorInfo = FH_CAN_SSD8_FuncPtr[i-1](fh_RFCommunication_Message);    // Call the related function
			}
			else
			{
