/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Root</b>, Section <b>FH_Perif</b>, <b>FH_CAN</b>, <b>Cmd</b> (Command), <b>Receive</b>, <b>Receive_H</b> (Receive Health)\n
...
/**
 * @brief This function verifies the health of <b>FH_CAN_Commands_Receive</b> command
 *
...
*/
FH_ErrorInfo FH_CAN_Receive_H(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	if (FH_MessageDataLength < FH_CAN_MinCommandSize_Receive)    // If the length is less than expected value
	{
	...
	FH_PeripheralNumber = fh_RFCommunication_Message -> Data[CAN_Receive_PeripheralNumber] ;
