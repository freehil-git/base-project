/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Root</b>, Section <b>FH_Perif</b>, <b>FH_CAN</b>, <b>Cmd</b> (Command), <b>Receive</b>, <b>Receive_C</b> (Receive Call)\n
...
*/
FH_ErrorInfo FH_CAN_Receive_C (FH_RFCommunication_Message* fh_RFCommunication_Message, uint8_t* fH_CAN_Data, uint8_t* fH_CAN_DataSize, FH_CAN_Receive_FuncPtrModel *fH_CAN_Receive_FuncPtr)
{
	...
	{
		if (i == fh_RFCommunication_Message -> Data[CAN_Receive_PeripheralNumber])    // If the PeripheralNumber in the message frame is met
		{
			if (fH_CAN_Receive_FuncPtr[i-1] != NULL_PTR)    // If the address of the function is truly assigned
			{
				fh_ErrorInfo = fH_CAN_Receive_FuncPtr[i-1](fh_RFCommunication_Message, fH_CAN_DataSize, fH_CAN_Data);    // Call the related function
			}
			else
			{
