/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Root</b>, Section <b>FH_Perif</b>, <b>FH_CAN</b>, <b>Cmd</b> (Command), <b>SSD32</b>, <b>SSD32_C</b> (Set Shared Data 32 Call)\n
...
*/
FH_ErrorInfo FH_CAN_SSD32_C (FH_RFCommunication_Message* fh_RFCommunication_Message, FH_CAN_SSD32_FuncPtrModel *FH_CAN_SSD32_FuncPtr)
{
	...
	{
		if (i == fh_RFCommunication_Message -> Data[CAN_SSD32_PeripheralNumber])    // If the PeripheralNumber in the message frame is met
		{
			if (FH_CAN_SSD32_FuncPtr[i-1] != NULL_PTR)    // If the address of the function is truly assigned
			{
				fh_ErrorInfo = FH_CAN_SSD32_FuncPtr[i-1](fh_RFCommunication_Message);    // Call the related function
			}
			else
			{
