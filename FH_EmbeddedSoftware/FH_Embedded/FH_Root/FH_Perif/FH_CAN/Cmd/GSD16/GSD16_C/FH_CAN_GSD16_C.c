/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Root</b>, Section <b>FH_Perif</b>, <b>FH_CAN</b>, <b>Cmd</b> (Command), <b>GSD16</b>, <b>GSD16_C</b> (Get Shared Data 16 Call)\n
...
*/
FH_ErrorInfo FH_CAN_GSD16_C (FH_RFCommunication_Message* fh_RFCommunication_Message, uint8_t* SharedDataLength, uint8_t* SharedData, FH_CAN_GSD16_FuncPtrModel *fH_CAN_GSD16_FuncPtr)
{
	...
	{
		if (i == fh_RFCommunication_Message -> Data[CAN_GSD16_PeripheralNumber])    // If the PeripheralNumber in the message frame is met
		{
			if (fH_CAN_GSD16_FuncPtr[i-1] != NULL_PTR)    // If the address of the function is truly assigned
			{
				fh_ErrorInfo = fH_CAN_GSD16_FuncPtr[i-1](fh_RFCommunication_Message, SharedDataLength, SharedData);    // Call the related function
			}
			else
			{
