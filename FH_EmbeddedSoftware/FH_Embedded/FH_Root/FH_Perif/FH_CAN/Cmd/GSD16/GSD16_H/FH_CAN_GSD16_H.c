...
/**
 * @brief This function verifies the health of <b>FH_CAN_Commands_GSD16</b> command
 *
...
FH_ErrorInfo FH_CAN_GSD16_H(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	if (FH_MessageDataLength < FH_CAN_MinCommandSize_GSD16)    // If the length is less than expected value
	{
	...
	FH_PeripheralNumber = fh_RFCommunication_Message -> Data[CAN_GSD16_PeripheralNumber];
