/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Root</b>, Section <b>FH_Perif</b>, <b>FH_CAN</b>, <b>Cmd</b> (Command), <b>Init</b>, <b>Init_H</b> (Init Health)\n
...
/**
 * @brief This function verifies the health of <b>FH_CAN_Commands_Init</b> command
 *
...
FH_ErrorInfo FH_CAN_Init_H(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	if (FH_MessageDataLength < FH_CAN_MinCommandSize_Init)    // If the length is less than expected value
	{
	...
	FH_PeripheralNumber = fh_RFCommunication_Message -> Data[CAN_Init_PeripheralNumber];
