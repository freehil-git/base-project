/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Root</b>, Section <b>FH_Perif</b>, <b>FH_CAN</b>, <b>Cmd</b> (Command), <b>GSD32</b>, <b>GSD32_C</b> (Get Shared Data 32 Call)\n
 ...
 *         *SharedDataLength will be set with the length of the related SharedDataBuf
 * @param  SharedData
 *         *SharedData will be set with the related SharedDataBuf
...
*/
FH_ErrorInfo FH_CAN_GSD32_C (FH_RFCommunication_Message* fh_RFCommunication_Message, uint8_t* SharedDataLength, uint8_t* SharedData, FH_CAN_GSD32_FuncPtrModel *fH_CAN_GSD32_FuncPtr)
{
	...
	{
		if (i == fh_RFCommunication_Message -> Data[CAN_GSD32_PeripheralNumber])    // If the PeripheralNumber in the message frame is met
		{
			if (fH_CAN_GSD32_FuncPtr[i-1] != NULL_PTR)    // If the address of the function is truly assigned
			{
				fh_ErrorInfo = fH_CAN_GSD32_FuncPtr[i-1](fh_RFCommunication_Message, SharedDataLength, SharedData);    // Call the related function
			}
			else
			{
