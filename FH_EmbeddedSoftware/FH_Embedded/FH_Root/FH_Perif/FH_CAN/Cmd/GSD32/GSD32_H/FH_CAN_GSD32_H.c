/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Root</b>, Section <b>FH_Perif</b>, <b>FH_CAN</b>, <b>Cmd</b> (Command), <b>GSD32</b>, <b>GSD32_H</b> (Get Shared Data 32 Health)\n
...
/**
 * @brief This function verifies the health of <b>FH_CAN_Commands_GSD32</b> command
 *
...
*/
FH_ErrorInfo FH_CAN_GSD32_H(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	if (FH_MessageDataLength < FH_CAN_MinCommandSize_GSD32)    // If the length is less than expected value
	{
	...
	FH_PeripheralNumber = fh_RFCommunication_Message -> Data[CAN_GSD32_PeripheralNumber];
