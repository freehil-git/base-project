/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Root</b>, Section <b>FH_Perif</b>, <b>FH_PWMO</b> (PWM Output), <b>Cmd</b> (Command), <b>Init</b>, <b>Init_H</b> (Init Health)\n
  *       Functions in this file, verify the health of the different message frames related to <b>PWMO_</b> (PWM Output)
  *
...
/**
 * @brief This function verifies the health of <b>FH_PWMO_Commands_Init</b> command
 *
...
*/
FH_ErrorInfo FH_PWMO_Init_H(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	if (FH_MessageDataLength < FH_PWMO_MinCommandSize_Init)    // If the length is less than expected value
	{
