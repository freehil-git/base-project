/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Root</b>, Section <b>FH_Perif</b>, <b>FH_DI</b> (PWM Input), <b>Cmd</b> (Command), <b>GetStatus</b>, <b>GetStatus_H</b> (GetStatus Health)\n
...
/**
 * @brief This function verifies the health of <b>FH_PWMI_Commands_GetStatus</b> command
 *
...
*/
FH_ErrorInfo FH_PWMI_GetStatus_H(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	if (FH_MessageDataLength < FH_PWMI_MinCommandSize_GetStatus)    // If the length is less than expected value
	{
	...
	if (FH_PeripheralNumber == 0 || FH_PeripheralNumber > FH_PWMI_MaxPeripheralNumber)    // If the PeripheralNumber is not within the expected value
	{
		fh_ErrorInfo.error_code = FH_ERROR_MessageFrame;    // There is message frame error
		return fh_ErrorInfo;
	}
