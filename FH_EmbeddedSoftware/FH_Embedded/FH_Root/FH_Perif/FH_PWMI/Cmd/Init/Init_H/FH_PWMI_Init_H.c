...
/**
 * @brief This function verifies the health of <b>FH_PWMI_Commands_Init</b> command
 *
...
FH_ErrorInfo FH_PWMI_Init_H(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	if (FH_MessageDataLength < FH_PWMI_MinCommandSize_Init)    // If the length is less than expected value
	{
