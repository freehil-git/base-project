/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Root</b>, Section <b>FH_Perif</b>, <b>FH_AI</b> (Analog Input), <b>Cmd</b> (Command), <b>Init</b>, <b>Init_H</b> (Init Health)\n
...
/**
 * @brief This function verifies the health of <b>FH_AI_Commands_Init</b> command
 *
...
*/
FH_ErrorInfo FH_AI_Init_H(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	if (FH_MessageDataLength < FH_AI_MinCommandSize_Init)    // If the length is less than expected value
	{
