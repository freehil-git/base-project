/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Root</b>, Section <b>FH_Perif</b>, <b>FH_DI</b> (Analog Input), <b>Cmd</b> (Command), <b>GetStatus</b>, <b>GetStatus_H</b> (GetStatus Health)\n
  *       Functions in this file, verify the health of the different message frames related to <b>AI</b> (Analog Input)
  *
...
/**
 * @brief This function verifies the health of <b>FH_AI_Commands_GetStatus</b> command
 *
...
*/
FH_ErrorInfo FH_AI_GetStatus_H(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	if (FH_MessageDataLength < FH_AI_MinCommandSize_GetStatus)    // If the length is less than expected value
	{
	...
	if (FH_PeripheralNumber == 0 || FH_PeripheralNumber > FH_AI_MaxPeripheralNumber)    // If the PeripheralNumber is not within the expected value
	{
		fh_ErrorInfo.error_code = FH_ERROR_MessageFrame;    // There is message frame error
		return fh_ErrorInfo;
	}
