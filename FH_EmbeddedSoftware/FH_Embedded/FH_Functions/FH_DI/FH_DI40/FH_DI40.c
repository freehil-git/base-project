/**
  ...
  *
  * @note To have a clean code, <b>FH</b> user should have the implementation of the initialization and read functions of the <b>Digital Input 40</b> in a separate c file\n
  ...
  *       The declaration of the initialization function of the <b>Digital Input 40</b>\n
  *       The declaration of the read function of the <b>Digital Input 40</b>
  *
...
/**
 * @brief This function initializes the <b>Digital Input 40</b>\n
 *        The <b>Digital Input 40</b> could be any interested Digital Input of the micro-controller on which <b>FH</b> source code is ported\n
 ...
 * @verbatim
    ...
    DI40 => It indicates the Digital Input 40
 ...
 *
 * @warning
 * To be able to read the <b>Digital Input 40</b> of the micro-controller on which <b>FH</b> source code is ported, this function shall be invoked once by <b>RobotFramework</b> firstly\n
 * In other words, before invoking <b>FH_DI_GetStatus_DI40</b> function from <b>RobotFramework</b>, this function shall be invoked in order to initialize the Digital Input
 *
...
FH_ErrorInfo FH_DI_Init_DI40()
{
	...
	// Attention 2: FH user defined code (call the initialization function of the Digital Input 40 here)
...
/**
 * @brief This function reads the <b>Digital Input 40</b>\n
 *        The <b>Digital Input 40</b> could be any interested Digital Input of the micro-controller on which <b>FH</b> source code is ported\n
 *        <b>FH</b> user should call the read function of the interested Digital Input here
 *
 * @param  Data
 *         If the read data of the <b>Digital Input 40</b> is 1, *Data will be set to 1\n
 *         If the read data of the <b>Digital Input 40</b> is 0, *Data will be set to 0
 * @return FH_ErrorInfo is returned
 *
 * @note
 * To have a clean code, just include the related header file\n
 ...
 *
 * @warning
 * To be able to read the <b>Digital Input 40</b> of the micro-controller on which <b>FH</b> source code is ported, the <b>FH_DI_Init_DI40</b> function shall be invoked once by <b>RobotFramework</b> firstly\n
 * In other words, before invoking <b>FH_DI_GetStatus_DI40</b> function from <b>RobotFramework</b>, <b>FH_DI_Init_DI40</b> function shall be invoked in order to initialize the Digital Input
 *
...
FH_ErrorInfo FH_DI_GetStatus_DI40(uint8_t* Data)
{
	FH_ErrorInfo fh_ErrorInfo;    // Error Information
	FH_ResetErrorInfo(&fh_ErrorInfo);    // Reset Error Information to default
	uint8_t readData = 0;    // Read data of the Digital Input 40
	
	// Attention 3: FH user defined code (call the read function the Digital Input 40 here)
