/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Functions</b>, Section <b>FH_AO</b> (Analog Output), Peripheral <b>FH_AO01</b> (Analog Output 01)\n
  *       (The <b>AO01 (Analog Output 01)</b> could be any interested Analog Output of the micro-controller on which <b>FH</b> source code is ported)\n
  *
  * @note To have a clean code, <b>FH</b> user should have the implementation of the initialization and set function of the <b>Analog Output 01</b> in a separate c file\n
  ...
  *       The declaration of the initialization function of the <b>Analog Output 01</b>\n
  *       The declaration of the set function of the <b>Analog Output 01</b>
  *
...
#ifdef FH_AO01    // It is configurable in FH_AO_Configs.h
...
/**
 * @brief This function initializes the <b>Analog Output 01</b>\n
 *        The <b>Analog Output 01</b> could be any interested Analog Output of the micro-controller on which <b>FH</b> source code is ported\n
 ...
 *
 * @warning
 * To be able to set or reset the <b>Analog Output 01</b> of the micro-controller on which <b>FH</b> source code is ported, this function shall be invoked once by <b>RobotFramework</b> firstly\n
 * In other words, before invoking <b>FH_AO_SetStatus_AO01</b> function from <b>RobotFramework</b>, this function shall be invoked in order to initialize the Analog Output
 *

*/
FH_ErrorInfo FH_AO_Init_AO01(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	FH_ErrorInfo fh_ErrorInfo;    // Error Information
	FH_ResetErrorInfo(&fh_ErrorInfo);    // Reset Error Information to default

	// Attention 2: FH user defined code (call the initialization function of the Analog Output 01 here)
...
/**
 * @brief This function sets the <b>Analog Output 01</b>\n
 *        The <b>Analog Output 01</b> could be any interested Analog Output of the micro-controller on which <b>FH</b> source code is ported\n
 ...
 *
 * @warning
 * To be able to set the <b>Analog Output 01</b> of the micro-controller on which <b>FH</b> source code is ported, the <b>FH_AO_Init_AO01</b> function shall be invoked once by <b>RobotFramework</b> firstly\n
 * In other words, before invoking <b>FH_AO_SetStatus_AO01</b> function from <b>RobotFramework</b>, <b>FH_AO_Init_AO01</b> function shall be invoked in order to initialize the Analog Output
 *

*/
FH_ErrorInfo FH_AO_SetStatus_AO01(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	FH_ErrorInfo fh_ErrorInfo;    // Error Information
	FH_ResetErrorInfo(&fh_ErrorInfo);    // Reset Error Information to default

	// Attention 3: FH user defined code (call the set function of the Analog Output 01 here with fh_RFCommunication_Message -> Data[...] as argument)
