/**
  ...
  *
  * @note To have a clean code, <b>FH</b> user should have the implementation of the initialization and set function of the <b>Analog Output 61</b> in a separate c file\n
  ...
  *       The declaration of the initialization function of the <b>Analog Output 61</b>\n
  *       The declaration of the set function of the <b>Analog Output 61</b>
  *
...
/**
 * @brief This function initializes the <b>Analog Output 61</b>\n
 *        The <b>Analog Output 61</b> could be any interested Analog Output of the micro-controller on which <b>FH</b> source code is ported\n
 ...
 * @verbatim
    ...
    AO61 => It indicates the Analog Output 61
 ...
 *
 * @warning
 * To be able to set or reset the <b>Analog Output 61</b> of the micro-controller on which <b>FH</b> source code is ported, this function shall be invoked once by <b>RobotFramework</b> firstly\n
 * In other words, before invoking <b>FH_AO_SetStatus_AO61</b> function from <b>RobotFramework</b>, this function shall be invoked in order to initialize the Analog Output
 *
...
FH_ErrorInfo FH_AO_Init_AO61(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	// Attention 2: FH user defined code (call the initialization function of the Analog Output 61 here)
...
/**
 * @brief This function sets the <b>Analog Output 61</b>\n
 *        The <b>Analog Output 61</b> could be any interested Analog Output of the micro-controller on which <b>FH</b> source code is ported\n
 ...
 * @verbatim
    ==============================================================================
                          ##### RobotFramework Example #####
    ==============================================================================
    @{MessageData} =    Create List    ${AO61}    F1    C2    01    08
    ...
    AO61 => It indicates the Analog Output 61
    F1    C2    01    08 => Example data as analog value (0xF1C20108) to be set through the <b>Analog Output 61</b>\n
    DeviceAddress_01 => It shall be equal to the address of the device: FH_RFCommunication_DeviceAddress
    Function_AO => It is the function in the message frame
 ...
 *
 * @warning
 * To be able to set the <b>Analog Output 61</b> of the micro-controller on which <b>FH</b> source code is ported, the <b>FH_AO_Init_AO61</b> function shall be invoked once by <b>RobotFramework</b> firstly\n
 * In other words, before invoking <b>FH_AO_SetStatus_AO61</b> function from <b>RobotFramework</b>, <b>FH_AO_Init_AO61</b> function shall be invoked in order to initialize the Analog Output
 *
...
FH_ErrorInfo FH_AO_SetStatus_AO61(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	// Attention 3: FH user defined code (call the set function the Analog Output 61 here with fh_RFCommunication_Message -> Data[...] as argument)
