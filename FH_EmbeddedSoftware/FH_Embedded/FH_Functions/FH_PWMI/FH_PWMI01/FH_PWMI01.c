/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Functions</b>, Section <b>FH_PWMI</b> (PWM Input), Peripheral <b>FH_PWMI01</b> (PWM Input 01)\n
  *       (The <b>PWMI01 (PWM Input 01)</b> could be any interested PWM Input of the micro-controller on which <b>FH</b> source code is ported)\n
  *
  * @note To have a clean code, <b>FH</b> user should have the implementation of the initialization and read functions of the <b>PWM Input 01</b> in a separate c file\n
  ...
  *       The declaration of the initialization function of the <b>PWM Input 01</b>\n
  *       The declaration of the read function of the <b>PWM Input 01</b>
  *
...
#ifdef FH_PWMI01    // It is configurable in FH_PWMI_Configs.h
...
/**
 * @brief This function initializes the <b>PWM Input 01</b>\n
 *        The <b>PWM Input 01</b> could be any interested PWM Input of the micro-controller on which <b>FH</b> source code is ported\n
 ...
 *
 * @warning
 * To be able to read the <b>PWM Input 01</b> of the micro-controller on which <b>FH</b> source code is ported, this function shall be invoked once by <b>RobotFramework</b> firstly\n
 * In other words, before invoking <b>FH_PWMI_GetStatus_PWMI01</b> function from <b>RobotFramework</b>, this function shall be invoked in order to initialize the PWM Input
 *

*/
FH_ErrorInfo FH_PWMI_Init_PWMI01(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	FH_ErrorInfo fh_ErrorInfo;    // Error Information
	FH_ResetErrorInfo(&fh_ErrorInfo);    // Reset Error Information to default

    // Attention 2: FH user defined code (call the initialization function of the PWM Input 01 here)
...
/**
 * @brief This function reads the <b>PWM Input 01</b>\n
 *        The <b>PWM Input 01</b> could be any interested PWM Input of the micro-controller on which <b>FH</b> source code is ported\n
 *        <b>FH</b> user should call the read function of the interested PWM Input here
 *
 * @param  Data
 *         *Data will be set with the value of <b>PWM Input 01</b>\n
 *
 * @return FH_ErrorInfo is returned
 *
 * @note
 ...
 *
 * @warning
 * To be able to read the <b>PWM Input 01</b> of the micro-controller on which <b>FH</b> source code is ported, the <b>FH_PWMI_Init_PWMI01</b> function shall be invoked once by <b>RobotFramework</b> firstly\n
 * In other words, before invoking <b>FH_PWMI_GetStatus_PWMI01</b> function from <b>RobotFramework</b>, <b>FH_PWMI_Init_PWMI01</b> function shall be invoked in order to initialize the PWM Input
 *

*/
FH_ErrorInfo FH_PWMI_GetStatus_PWMI01(FH_RFCommunication_Message* fh_RFCommunication_Message, uint32_t* fh_Frequency, uint8_t* fh_DutyCycle)
{
	FH_ErrorInfo fh_ErrorInfo;    // Error Information
	FH_ResetErrorInfo(&fh_ErrorInfo);    // Reset Error Information to default

	// Attention 3: FH user defined code (call the read function the PWM Input 01 here)
