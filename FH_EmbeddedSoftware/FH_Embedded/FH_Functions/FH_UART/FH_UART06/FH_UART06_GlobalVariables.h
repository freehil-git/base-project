/**
  ...
  *       Global variables and arrays of UART06 are defined here
...
#ifndef FH_UART06_GlobalVariables_H
#define FH_UART06_GlobalVariables_H
...
#include "../../../../FH_Embedded/FH_Root/FH_Perif/FH_UART/FH_UART_Configs/FH_UART_Configs.h"
	...
	extern volatile uint8_t FH_UART06_ReceiveBuf[];
	extern volatile uint16_t FH_UART06_ReceiveBufIndex;

	extern volatile uint8_t  FH_UART06_SharedDataBuf_8Bits [];
	extern volatile uint16_t FH_UART06_SharedDataBuf_16Bits[];
	extern volatile uint32_t FH_UART06_SharedDataBuf_32Bits[];
