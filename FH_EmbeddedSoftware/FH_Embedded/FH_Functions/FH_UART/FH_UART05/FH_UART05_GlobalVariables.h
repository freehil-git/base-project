/**
  ...
  *       Global variables and arrays of UART05 are defined here
...
#ifndef FH_UART05_GlobalVariables_H
#define FH_UART05_GlobalVariables_H
...
#include "../../../../FH_Embedded/FH_Root/FH_Perif/FH_UART/FH_UART_Configs/FH_UART_Configs.h"
	...
	extern volatile uint8_t FH_UART05_ReceiveBuf[];
	extern volatile uint16_t FH_UART05_ReceiveBufIndex;

	extern volatile uint8_t  FH_UART05_SharedDataBuf_8Bits [];
	extern volatile uint16_t FH_UART05_SharedDataBuf_16Bits[];
	extern volatile uint32_t FH_UART05_SharedDataBuf_32Bits[];
