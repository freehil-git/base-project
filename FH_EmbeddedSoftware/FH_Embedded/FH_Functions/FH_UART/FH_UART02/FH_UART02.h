...
FH_ErrorInfo FH_UART_Receive_UART02 (FH_RFCommunication_Message* fh_RFCommunication_Message, uint8_t* FH_DataSize, uint8_t* FH_Data);
FH_ErrorInfo FH_UART_ReceiveW_UART02 (FH_RFCommunication_Message* fh_RFCommunication_Message, uint8_t* FH_DataSize, uint8_t* FH_Data);
