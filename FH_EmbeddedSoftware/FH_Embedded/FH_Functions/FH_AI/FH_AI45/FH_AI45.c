/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Functions</b>, Section <b>FH_AI</b> (Analog Input), Peripheral <b>FH_AI45</b> (Analog Input 45)\n
  *       (The <b>AI45 (Analog Input 45)</b> could be any interested Analog Input of the micro-controller on which <b>FH</b> source code is ported)\n
  *
  * @note To have a clean code, <b>FH</b> user should have the implementation of the initialization and read functions of the <b>Analog Input 45</b> in a separate c file\n
  ...
  *       The declaration of the initialization function of the <b>Analog Input 45</b>\n
  *       The declaration of the read function of the <b>Analog Input 45</b>
  *
...
#ifdef FH_AI45    // It is configurable in FH_AI_Configs.h
...
/**
 * @brief This function initializes the <b>Analog Input 45</b>\n
 *        The <b>Analog Input 45</b> could be any interested Analog Input of the micro-controller on which <b>FH</b> source code is ported\n
 ...
 *
 * @warning
 * To be able to read the <b>Analog Input 45</b> of the micro-controller on which <b>FH</b> source code is ported, this function shall be invoked once by <b>RobotFramework</b> firstly\n
 * In other words, before invoking <b>FH_AI_GetStatus_AI45</b> function from <b>RobotFramework</b>, this function shall be invoked in order to initialize the Analog Input
 *
...
FH_ErrorInfo FH_AI_Init_AI45(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
    ...
    // Attention 2: FH user defined code (call the initialization function of the Analog Input 45 here)
...
/**
 * @brief This function reads the <b>Analog Input 45</b>\n
 *        The <b>Analog Input 45</b> could be any interested Analog Input of the micro-controller on which <b>FH</b> source code is ported\n
 *        <b>FH</b> user should call the read function of the interested Analog Input here
 *
 * @param  Data
 *         *Data will be set with the value of <b>Analog Input 45</b>\n
 *
 * @return FH_ErrorInfo is returned
 *
 * @note
 ...
 *
 * @warning
 * To be able to read the <b>Analog Input 45</b> of the micro-controller on which <b>FH</b> source code is ported, the <b>FH_AI_Init_AI45</b> function shall be invoked once by <b>RobotFramework</b> firstly\n
 * In other words, before invoking <b>FH_AI_GetStatus_AI45</b> function from <b>RobotFramework</b>, <b>FH_AI_Init_AI45</b> function shall be invoked in order to initialize the Analog Input
 *
...
FH_ErrorInfo FH_AI_GetStatus_AI45(FH_RFCommunication_Message* fh_RFCommunication_Message, uint32_t* Data)
{
	FH_ErrorInfo fh_ErrorInfo;    // Error Information
	FH_ResetErrorInfo(&fh_ErrorInfo);    // Reset Error Information to default
	uint32_t readData = 0;    // Read data of the Analog Input 45

	// Attention 3: FH user defined code (call the read function the Analog Input 45 here)
