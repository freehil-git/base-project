/**
  ...
  *
  * @note To have a clean code, <b>FH</b> user should have the implementation of the initialization and read functions of the <b>Analog Input 30</b> in a separate c file\n
  ...
  *       The declaration of the initialization function of the <b>Analog Input 30</b>\n
  *       The declaration of the read function of the <b>Analog Input 30</b>
  *
...
/**
 * @brief This function initializes the <b>Analog Input 30</b>\n
 *        The <b>Analog Input 30</b> could be any interested Analog Input of the micro-controller on which <b>FH</b> source code is ported\n
 ...
 * @verbatim
    ...
    AI30 => It indicates the Analog Input 30
 ...
 *
 * @warning
 * To be able to read the <b>Analog Input 30</b> of the micro-controller on which <b>FH</b> source code is ported, this function shall be invoked once by <b>RobotFramework</b> firstly\n
 * In other words, before invoking <b>FH_AI_GetStatus_AI30</b> function from <b>RobotFramework</b>, this function shall be invoked in order to initialize the Analog Input
 *
...
FH_ErrorInfo FH_AI_Init_AI30(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
    ...
    // Attention 2: FH user defined code (call the initialization function of the Analog Input 30 here)
...
/**
 * @brief This function reads the <b>Analog Input 30</b>\n
 *        The <b>Analog Input 30</b> could be any interested Analog Input of the micro-controller on which <b>FH</b> source code is ported\n
 *        <b>FH</b> user should call the read function of the interested Analog Input here
 *
 * @param  Data
 *         *Data will be set with the value of <b>Analog Input 30</b>\n
 *
 * @return FH_ErrorInfo is returned
 *
 * @note
 ...
 *
 * @warning
 * To be able to read the <b>Analog Input 30</b> of the micro-controller on which <b>FH</b> source code is ported, the <b>FH_AI_Init_AI30</b> function shall be invoked once by <b>RobotFramework</b> firstly\n
 * In other words, before invoking <b>FH_AI_GetStatus_AI30</b> function from <b>RobotFramework</b>, <b>FH_AI_Init_AI30</b> function shall be invoked in order to initialize the Analog Input
 *
...
FH_ErrorInfo FH_AI_GetStatus_AI30(FH_RFCommunication_Message* fh_RFCommunication_Message, uint32_t* Data)
{
	FH_ErrorInfo fh_ErrorInfo;    // Error Information
	FH_ResetErrorInfo(&fh_ErrorInfo);    // Reset Error Information to default
	uint32_t readData = 0;    // Read data of the Analog Input 30

	// Attention 3: FH user defined code (call the read function the Analog Input 30 here)
