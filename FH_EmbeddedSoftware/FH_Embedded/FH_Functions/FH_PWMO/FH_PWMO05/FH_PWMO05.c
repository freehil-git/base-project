/**
  ...
  *       (The <b>PWMO05 (PWM Output 05)</b> could be any interested PWM Output of the micro-controller on which <b>FH</b> source code is ported)\n
  *
  * @note To have a clean code, <b>FH</b> user should have the implementation of the initialization and set function of the <b>PWM Output 05</b> in a separate c file\n
  ...
  *       The declaration of the initialization function of the <b>PWM Output 05</b>\n
  *       The declaration of the set function of the <b>PWM Output 05</b>
  *
...
/**
 * @brief This function initializes the <b>PWM Output 05</b>\n
 *        The <b>PWM Output 05</b> could be any interested PWM Output of the micro-controller on which <b>FH</b> source code is ported\n
 ...
 * @verbatim
    ...
    ==============================================================================
    @{MessageData} =    Create List    ${PWMO05}
    ...
    PWMO05 => It indicates the PWM Output 05
 ...
 *
 * @warning
 * To be able to set or reset the <b>PWM Output 05</b> of the micro-controller on which <b>FH</b> source code is ported, this function shall be invoked once by <b>RobotFramework</b> firstly\n
 * In other words, before invoking <b>FH_PWMO_SetStatus_PWMO05</b> function from <b>RobotFramework</b>, this function shall be invoked in order to initialize the PWM Output
 *
...
FH_ErrorInfo FH_PWMO_Init_PWMO05(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	// Attention 2: FH user defined code (call the initialization function of the PWM Output 05 here)
...
/**
 * @brief This function sets the <b>PWM Output 05</b>\n
 *        The <b>PWM Output 05</b> could be any interested PWM Output of the micro-controller on which <b>FH</b> source code is ported\n
 ...
 * @verbatim
    ==============================================================================
                          ##### RobotFramework Example #####
    ==============================================================================
    @{MessageData} =    Create List    ${PWMO05}    00    00    00    F0    32
    ...
    PWMO05 => It indicates the PWM Output 05
    00    00    00    F0 => Example data as PWM frequency (0x000000F0) to be set through the <b>PWM Output 05</b>\n
    32 => Example data as PWM duty cycle (0x32 => as 50% duty cycle) to be set through the <b>PWM Output 05</b>\n
    DeviceAddress_01 => It shall be equal to the address of the device: FH_RFCommunication_DeviceAddress
    Function_PWMO => It is the function in the message frame
 ...
 *
 * @warning
 * To be able to set the <b>PWM Output 05</b> of the micro-controller on which <b>FH</b> source code is ported, the <b>FH_PWMO_Init_PWMO05</b> function shall be invoked once by <b>RobotFramework</b> firstly\n
 * In other words, before invoking <b>FH_PWMO_SetStatus_PWMO05</b> function from <b>RobotFramework</b>, <b>FH_PWMO_Init_PWMO05</b> function shall be invoked in order to initialize the PWM Output
 *
...
FH_ErrorInfo FH_PWMO_SetStatus_PWMO05(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	// Attention 3: FH user defined code (call the set function of the PWM Output 05 here with fh_RFCommunication_Message -> Data[...] as argument)
