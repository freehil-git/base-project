/**
  ...
  * @brief
  *       <b>File Map:</b>\n
  *       <b>FH_Functions</b>, Section <b>FH_PWMO</b> (PWM Output), Peripheral <b>FH_PWMO41</b> (PWM Output 41)\n
  *       (The <b>PWMO41 (PWM Output 41)</b> could be any interested PWM Output of the micro-controller on which <b>FH</b> source code is ported)\n
  *
  * @note To have a clean code, <b>FH</b> user should have the implementation of the initialization and set function of the <b>PWM Output 41</b> in a separate c file\n
  ...
  *       The declaration of the initialization function of the <b>PWM Output 41</b>\n
  *       The declaration of the set function of the <b>PWM Output 41</b>
  *
...
#ifdef FH_PWMO41    // It is configurable in FH_PWMO_Configs.h
...
/**
 * @brief This function initializes the <b>PWM Output 41</b>\n
 *        The <b>PWM Output 41</b> could be any interested PWM Output of the micro-controller on which <b>FH</b> source code is ported\n
 ...
 *
 * @warning
 * To be able to set or reset the <b>PWM Output 41</b> of the micro-controller on which <b>FH</b> source code is ported, this function shall be invoked once by <b>RobotFramework</b> firstly\n
 * In other words, before invoking <b>FH_PWMO_SetStatus_PWMO41</b> function from <b>RobotFramework</b>, this function shall be invoked in order to initialize the PWM Output
 *
...
FH_ErrorInfo FH_PWMO_Init_PWMO41(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	// Attention 2: FH user defined code (call the initialization function of the PWM Output 41 here)
...
/**
 * @brief This function sets the <b>PWM Output 41</b>\n
 *        The <b>PWM Output 41</b> could be any interested PWM Output of the micro-controller on which <b>FH</b> source code is ported\n
 ...
 *
 * @warning
 * To be able to set the <b>PWM Output 41</b> of the micro-controller on which <b>FH</b> source code is ported, the <b>FH_PWMO_Init_PWMO41</b> function shall be invoked once by <b>RobotFramework</b> firstly\n
 * In other words, before invoking <b>FH_PWMO_SetStatus_PWMO41</b> function from <b>RobotFramework</b>, <b>FH_PWMO_Init_PWMO41</b> function shall be invoked in order to initialize the PWM Output
 *
...
FH_ErrorInfo FH_PWMO_SetStatus_PWMO41(FH_RFCommunication_Message* fh_RFCommunication_Message)
{
	...
	// Attention 3: FH user defined code (call the set function of the PWM Output 41 here with fh_RFCommunication_Message -> Data[...] as argument)
