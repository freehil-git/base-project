/**
  ...
  *       Global variables and arrays of CAN01 are defined here
...
#ifndef FH_CAN01_GlobalVariables_H
#define FH_CAN01_GlobalVariables_H
...
#include "../../../../FH_Embedded/FH_Root/FH_Perif/FH_CAN/FH_CAN_Configs/FH_CAN_Configs.h"
	...
	extern volatile uint8_t FH_CAN01_ReceiveBuf[];
	extern volatile uint16_t FH_CAN01_ReceiveBufIndex;

	extern volatile uint8_t  FH_CAN01_SharedDataBuf_8Bits [];
	extern volatile uint16_t FH_CAN01_SharedDataBuf_16Bits[];
	extern volatile uint32_t FH_CAN01_SharedDataBuf_32Bits[];
